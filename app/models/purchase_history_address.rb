class PurchaseHistoryAddress
  ...
  attr_accessor :postal_cord, :prefectures_id, :municipalities, :house_number, :building_name, :telephone_number, :user_id,
                :item_id, :token
  ...
  def save
    ...
    Address.create(postal_cord: postal_cord, prefectures_id: prefectures_id, municipalities: municipalities,
